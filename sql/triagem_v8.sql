...
left join w24_ee e on n.rnc = e.rnc and n.cellid = e.cellid
...
left join (select *,get_nodeb_name(node, 'nodeb') as nodeb_norm  from umts_kpi.vw_tx_integrity) t on n.nodeb = t.nodeb_norm and n.year = t.year and n.week = t.week
...
group by node,element_id,status) b on n.rnc=b.node and n.cellid::text = b.element_id
  where n.year = 2017 and n.week = 24) t1
  
  

) to '/home/postgres/dump/w24_triage.csv' delimiter ';' csv header		