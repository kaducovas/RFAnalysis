...
atm_dl_utilization,atm_ul_utilization,			
                ...
                from
(select
rncNAME,nodeb,atm.norm,ani,transt,atm.datetime,vs_iub_flowctrol_ul_dropnum_lgcport1,vs_iub_flowctrol_dl_dropnum_lgcport1,vs_iub_flowctrol_ul_congtime_lgcport1,vs_iub_flowctrol_dl_congtime_lgcport1,
...
on tx_atm.rncNAME = tx_ip.rnc and tx_atm.ani = tx_ip.ani
